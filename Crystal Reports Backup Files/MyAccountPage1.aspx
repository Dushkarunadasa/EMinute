<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="MyAccountPage1.aspx.cs" Inherits="M_sheet.MyAccountPage1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <fieldset>
        ...
        <div class="form-group">
            <div class="alert alert-dark alert-dark">
                <div class="row">
                    <div class="col-6">
            ...
            <div class="row">
                <h4 class="card-title">Minutes Outbox</h4>
            </div>
            <br />
            ...
            <div class="row card text-white bg-dark mb-3">
                ...
                <asp:GridView ID="GVInbox" runat="server" Height="61px" Width="1289px"
